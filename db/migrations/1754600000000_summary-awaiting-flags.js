/**
 * Add computed operational flags on v_appointment_status_summary:
 *   reminder_sent  — any successful outbound (sent_at set)
 *   awaiting_send  — scheduled, no successful reminder yet
 *   awaiting_reply — scheduled, reminder sent, no inbound reply yet
 *
 * These are NOT new appointment.status enum values — pipeline states derived from messages.
 *
