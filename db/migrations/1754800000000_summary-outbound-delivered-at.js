/**
 * Expose latest_outbound_delivered_at on v_appointment_status_summary so the
 * clinic status page can show when the outbound SMS actually reached the patient
 * (messages.delivered_at) — distinct from inbound reply time.
 *
